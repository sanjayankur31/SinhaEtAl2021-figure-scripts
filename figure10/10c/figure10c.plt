...
set border 3
set key inside maxrows 2 samplen 1 horizontal Left
...
plot "new.csv" using ($1/1000 - 1500):(($3-stab_new_E)*0.5) with lines ls 2 title "D gE", "new.csv" using ($1/1000 - 1500):(($4-stab_new_I)*3) with lines ls 6 title "D gI", "new.csv" using ($1/1000 - 1500):($5-stab_new_net) with lines lc 1 title "D gn",
