...
## LPZ C
set output simid."-81-conductance-rowstacked-histograms-E-to-p_lpz_E.tex"
plot for [COL=5:2:-1] '08-syn_conns-to-p_lpz_E-EE.csv' every 1 using COL:xtic(sprintf("%.1f", $1/1000)) fill pattern COL-1 title columnheader
